...
$ten = $_SESSION["ho_ten"] ?? "User";
$username = $_SESSION["ten_dang_nhap"] ?? "user";
$role = $_SESSION["vai_tro"] ?? "Guest";
$ma_nguoi_dung = $_SESSION["ma_nguoi_dung"] ?? 0;

// Lấy avatar từ database
$avatar = '';
$avatar_display = strtoupper(substr($username, 0, 2)); // Mặc định lấy 2 chữ đầu username
...
<style>
    ...
    * {
    ...
    .topbar-user-avatar {
      ...
      font-weight: 600;
      font-size: 13px;
      overflow: hidden; /* Thêm overflow hidden để ảnh không bị tràn */
    }
...
<header class="wms-topbar">
  ...
  <div class="topbar-left">
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb">
      <a href="/Project_QuanLyKhoHang/public/dashboard.php" class="breadcrumb-item">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"></path>
        </svg>
      </a>
      <span class="breadcrumb-separator">/</span>
      <span class="breadcrumb-item active"><?= $page_title ?? "Dashboard" ?></span>
    </nav>
    ...
    <div class="topbar-user" id="userDropdown">
      ...
      <div class="topbar-user-trigger" id="userTrigger">
        <div class="topbar-user-avatar">
          <?php if ($avatar && file_exists(__DIR__ . '/../../uploads/avatars/' . $avatar)): ?>
            <img src="/Project_QuanLyKhoHang/uploads/avatars/<?= htmlspecialchars($avatar) ?>" alt="Avatar">
          <?php else: ?>
            <?= $avatar_display ?>
          <?php endif; ?>
        </div>
      ...
      <div class="user-dropdown">
        ...
        <div class="user-dropdown-header">
          <div class="user-dropdown-name"><?= $ten ?></div>
          <div class="user-dropdown-email">Role: <?= $role ?></div>
        </div>

        <div class="user-dropdown-menu">
          <a href="/Project_QuanLyKhoHang/public/profile.php" class="user-dropdown-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a href="/Project_QuanLyKhoHang/public/404.php" class="user-dropdown-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a href="/Project_QuanLyKhoHang/actions/QuanLyDangNhap/logout.php" class="user-dropdown-item danger">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
