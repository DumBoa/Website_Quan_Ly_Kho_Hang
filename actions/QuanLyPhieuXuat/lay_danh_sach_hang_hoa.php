...
try {
    ...
    // Lấy danh sách hàng hóa với tồn kho - SỬA: lấy gia_ban làm giá xuất
    $sql = "SELECT 
                hh.ma_hang_hoa, 
                hh.ma_san_pham, 
                hh.ten_hang_hoa, 
                hh.gia_ban as gia_xuat,  -- Đổi từ gia_nhap thành gia_ban
                hh.trang_thai,
                dm.ten_danh_muc,
                k.ma_kho,
                k.ten_kho,
